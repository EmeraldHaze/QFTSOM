...
nodemap = Net("hub", {\
    "hub":    Node(["game1", "game2", "game3", "change", "custom", "ideas"],
        ["Game #1", "Game #2", "Game #3", "Change Defaults",
         "Custom Game", "Ideas"],
         {'say': "Here are some game presets. You can change the defaults "
         "(rules and exit conditions) which will apply to presets, and/or make"
         " your own game. It may not work, note. Being a good person, you'll "
         "also give feedback and ideas."}),
    "game1":  game1,
    "game2":  game2,
    "game3":  game3,
